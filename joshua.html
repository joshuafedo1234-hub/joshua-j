...
li:hover{
    background-color: lightslategray;//Declare a variable to store the searched city
var city="";
...
$("#clear-history").on("click",clearHistory);//Declare a variable to store the searched city
var city="";
// variable declaration
var searchCity = $("#search-city");
var searchButton = $("#search-button");
